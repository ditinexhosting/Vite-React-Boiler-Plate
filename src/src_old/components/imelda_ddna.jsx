...
const SoulMachineComponent = () => {
  const apiKey = 'eyJzb3VsSWQiOiJkZG5hLXJvYi1saW5lcy1vcmdjZjE3LS1pbWVsZGFkZXBsb3ltZW50IiwiYXV0aFNlcnZlciI6Imh0dHBzOi8vZGguc291bG1hY2hpbmVzLmNsb3VkL2FwaS9qd3QiLCJhdXRoVG9rZW4iOiJhcGlrZXlfdjFfOTc1NGE5NTYtZjIxOC00MzdjLWI3NmItYzU2NmU3MzkxMzk2In0=';
  ...
  const handleFeedback = async () => {
    fetch('/api/insert_imelda_conversation', {
      method: 'POST',
      headers: {
  ...
  return (
    ...
    <div className="soul-machine-container">
      ...
      <div className="overlay-buttons-right">
        <button className="overlay-button" onClick={toggleTranscript}>
          <img src={cc} alt="CC" />
        ...
        <button className="overlay-button" onClick={handleFeedback}>
